...
declare module 'vscode' {
	...
	export class ChatResponseProgressPart2 extends ChatResponseProgressPart {
		value: string;
		task?: (progress: Progress<string>) => Thenable<string | void>;
		constructor(value: string, task?: (progress: Progress<string>) => Thenable<string | void>);
	}
	...
	export interface ChatResponseStream {
		 ...
		 * @returns This stream.
		 */
		progress(value: string, task?: (progress: Progress<string>) => Thenable<string | void>): void;
